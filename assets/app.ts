...
// drawer menu construction
const toggleButton = document.getElementById("drawer-toggle");
const hiddenDrawerCheckbox = document.getElementById(
  "my-drawer"
) as HTMLInputElement;

if (!toggleButton || !hiddenDrawerCheckbox) {
  throw new Error("Couldn't build UI correctly");
}
